...
class Resources:
    ...
    def arginfo(detail_kwargs=True):
        ...
        doc_cpu_per_node = "Number of CPUs requested on each node for each scheduler job."
        doc_gpu_per_node = "Number of GPUs requested on each node for each scheduler job."
        doc_queue_name = (
