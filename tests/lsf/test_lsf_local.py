...
class TestLSF(unittest.TestCase):
    ...
    def test_sub_success(self):
        ...
        self.assertTrue(
            os.path.isfile(
                os.path.join(
                    "rmt", self.lsf.context.remote_root, "task0/tag_0_finished"
                )
            )
        )
        self.assertTrue(
            os.path.isfile(
                os.path.join(
                    "rmt", self.lsf.context.remote_root, "task0/tag_1_finished"
                )
            )
        )
        self.assertTrue(
            os.path.isfile(
                os.path.join(
                    "rmt", self.lsf.context.remote_root, "task1/tag_0_finished"
                )
            )
        )
        self.assertTrue(
            os.path.isfile(
                os.path.join(
                    "rmt", self.lsf.context.remote_root, "task1/tag_1_finished"
                )
            )
        )
        self.assertTrue(
            os.path.isfile(
                os.path.join("rmt", self.lsf.context.remote_root, "tag_finished")
            )
        )
        self.assertTrue(
            os.path.isfile(
                os.path.join("rmt", self.lsf.context.remote_root, "task0/test1")
            )
        )
        self.assertTrue(
            os.path.isfile(
                os.path.join("rmt", self.lsf.context.remote_root, "task1/test1")
            )
        )
        self.assertTrue(
            os.path.isfile(
                os.path.join("rmt", self.lsf.context.remote_root, "task0/test2")
            )
        )
        self.assertTrue(
            os.path.isfile(
                os.path.join("rmt", self.lsf.context.remote_root, "task1/test2")
            )
        )
