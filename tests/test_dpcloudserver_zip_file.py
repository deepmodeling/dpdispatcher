...
class TestZipFileList(unittest.TestCase):
    def test_file_list_default_is_none(self) -> None:
        default = inspect.signature(zip_file_list).parameters["file_list"].default
        self.assertIsNone(default)

    def test_omitted_file_list_creates_empty_archive(self) -> None:
    ...
    def test_explicit_patterns_are_not_modified(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            root = Path(temp_dir)
